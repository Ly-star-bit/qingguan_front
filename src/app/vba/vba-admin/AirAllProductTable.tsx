...
const AirAllProductTable: React.FC = () => {
    ...
    const handleRouteSearch = (values: any) => {
        ...
        // 获取产品数据
        fetchAllProducts(start, dest, '空运');
    };
    ...
    return (
        <div className={styles.formContainer}>
            <h1 className={styles.title}>空运产品管理</h1>
            ...
            {showTable && (
                <>
                    ...
                    <Row justify="space-between" style={{ marginBottom: 16 }}>
                        <Space>
                            <strong>当前路线：{ROUTE_CONFIGS[currentRoute as keyof typeof ROUTE_CONFIGS]?.label} - 空运</strong>
                        </Space>
                        <Space>
...
export default AirAllProductTable;
