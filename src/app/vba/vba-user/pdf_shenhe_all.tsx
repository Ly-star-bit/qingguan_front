...
import { Button, Input, Modal, DatePicker, message, Space, Tooltip, Select, Dropdown, Card, Row, Col, Typography, Segmented } from 'antd';
...
const PdfViewDownloadUserAll = () => {
  ...
  const baseColumns: ProColumns<CustomsClearSummaryLog>[] = [
    {
      title: '🔒',
      dataIndex: 'lock',
      width: 60,
  ...
  const seaSpecificColumn: ProColumns<CustomsClearSummaryLog> = {
    title: '预估整票税金CNY/Kg',
  ...
  const commonColumns: ProColumns<CustomsClearSummaryLog>[] = [
    {
      title: '备注',
      dataIndex: 'remarks',
      key: 'remarks',
        ...
        <Row gutter={[16, 16]} style={{ marginTop: 16 }}>
          ...
          <Col span={8}>
            ...
            <Select
              ...
              value={searchConveyType}
              onChange={value => setsearchConveyType(value)}
              style={{ width: '100%', marginTop: 4 }}
              showSearch
              allowClear
              options={getConveyTypeOptions()}
            />
          </Col>
          <Col span={8}>
...
export default PdfViewDownloadUserAll;
